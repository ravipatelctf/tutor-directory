            ...
            {tutorsData?.length > 0 ? (
              tutorsData.map((tutor) => (
                ...
                >
                  ...
                  <p><span className="font-bold">Country: </span>{tutor.country}</p>
                  <p><span className="font-bold">State: </span>{tutor.stateOrUT}</p>
                  <p><span className="font-bold">District: </span>{tutor.district}</p>
                  <p><span className="font-bold">Landmark: </span>{tutor.landmark}</p>

                  <div className="mt-4">
                    <button
                      onClick={() =>
                        window.open(
                          `https://wa.me/${tutor.phoneNumber}?text=Hi%20I%20found%20your%20tutor%20profile%20on%20TutorDirectory%20and%20want%20to%20connect.`,
                          "_blank"
                        )
                      }
